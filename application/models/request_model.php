...
class Request_model extends CI_Model{
	...
	//use in insert_request function
	...
	//Insert new request 
		//new queue for LIVE
			//environment is "UAT" and status is "exported", selected latest revision number per translation
		//new revisionNumber
	...
	//function get_my_request_by_environment($userID, $environment){
		//WHERE environment = "UAT" AND ownerID = userID and (status = "in queue" OR status = "reviewing")
	//}
	
	// function search_request($projectID, $taskID){
